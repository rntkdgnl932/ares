    ...
    try:
        ...
        while dun_go_ is False:
            ...
            if imgs_ is not None and imgs_ != False:
                ...
                print("모리아기지")
                y_reg = 760 + (int(where_dungeon[1]) * 35)
                    ...
                    for x in range(10):
                        ...
                        if move_ == True:
                            ...
                            if where_dungeon[1] == "1":
                                ...
                                full_path = "c:\\my_games\\ares\\data_ares\\imgs\\dungeon\\gyungjang\\moria_map_4.PNG"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                ...
                if imgs_ is not None and imgs_ != False:
                    ...
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set_(430, 400, 600, 545, cla, img, 0.7)
                    if imgs_ is not None and imgs_ != False:
                        print("미오픈...완료로 변경")
                        # add...
                        myQuest_play_add(cla, dungeon)
                ...
                if imgs_ is not None and imgs_ != False:
                    ...
                    if imgs_ is not None and imgs_ != False:
                        ...
                        if imgs_ is not None and imgs_ != False:
                            ...
                            full_path = "c:\\my_games\\ares\\data_ares\\imgs\\dungeon\\gyungjang\\moria_juljun_map_title_1_4.PNG"
                            img_array = np.fromfile(full_path, np.uint8)
                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                            imgs_ = imgs_set_(10, 50, 90, 90, cla, img, 0.8)
                            if imgs_ is not None and imgs_ != False:
                                ...
                                full_path = "c:\\my_games\\ares\\data_ares\\imgs\\dungeon\\gyungjang\\moria_juljun_map_title_2_1.PNG"
                                img_array = np.fromfile(full_path, np.uint8)
                                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                imgs_ = imgs_set_(10, 50, 90, 90, cla, img, 0.8)
                                if imgs_ is not None and imgs_ != False:
                                    ...
                                    if imgs_ is not None and imgs_ != False:
                                        ...
                                        full_path = "c:\\my_games\\ares\\data_ares\\imgs\\dungeon\\gyungjang\\moria_juljun_map_title_2_3.PNG"
                                        img_array = np.fromfile(full_path, np.uint8)
                                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                        imgs_ = imgs_set_(10, 50, 90, 90, cla, img, 0.8)
                                        if imgs_ is not None and imgs_ != False:
        ...
        while dun_go_ is False:
            ...
            if imgs_ is not None and imgs_ != False:
                ...
                if imgs_ is not None and imgs_ != False:
                    ...
                    img_array = np.fromfile(full_path, np.uint8)
                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                    imgs_ = imgs_set_(620, 400, 800, 545, cla, img, 0.7)
                    if imgs_ is not None and imgs_ != False:
                        print("미오픈...완료로 변경")
                        # add...
                        myQuest_play_add(cla, dungeon)
