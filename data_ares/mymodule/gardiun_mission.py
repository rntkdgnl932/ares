    ...
    try:
        ...
        while mission_get_ is False:
            ...
            if imgs_ is not None and imgs_ != False:
                ...
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set_(175, 110, 200, 1040, cla, img, 0.85)
                if imgs_ is not None and imgs_ != False:
                        ...
                        if imgs_ is not None and imgs_ != False:
                            ...
                            for s in range(3):
                                ...
                                if imgs_ is not None and imgs_ != False:
                                    ...
                                    full_path = "c:\\my_games\\ares\\data_ares\\imgs\\gardiun_mission\\a_grade.PNG"
                                    img_array = np.fromfile(full_path, np.uint8)
                                    img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                    imgs_ = imgs_set_(5, 110, 60, 1040, cla, img, 0.7)
                                    if imgs_ is not None and imgs_ != False:
                                        ...
                                        full_path = "c:\\my_games\\ares\\data_ares\\imgs\\gardiun_mission\\b_grade.PNG"
                                        img_array = np.fromfile(full_path, np.uint8)
                                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                        imgs_ = imgs_set_(5, 110, 60, 1040, cla, img, 0.7)
                                        if imgs_ is not None and imgs_ != False:
                            ...
                            if imgs_ is not None and imgs_ != False:
                                ...
                                if any_more == True:
                                    ...
                                    if imgs_ is not None and imgs_ != False:
                                        ...
                                        full_path = "c:\\my_games\\ares\\data_ares\\imgs\\gardiun_mission\\gardiun_complete_zero3.PNG"
                                        img_array = np.fromfile(full_path, np.uint8)
                                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
