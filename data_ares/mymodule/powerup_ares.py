                                            ...
                                            if imgs_ is not None and imgs_ != False:
                                                ...
                                                if imgs_ is not None and imgs_ != False:
                                                    ...
                                                    if imgs_ is not None and imgs_ != False:
                                                        ...
                                                        full_path = "c:\\my_games\\ares\\data_ares\\imgs\\powerup\\hoilodo_point_9.PNG"
                                                        img_array = np.fromfile(full_path, np.uint8)
                                                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                                        imgs_ = imgs_set_(150, 310, 800, 880, cla, img, 0.8)
                                                        if imgs_ is not None and imgs_ != False:
                                                            print("hoilodo_point_9", imgs_)
                                                            click_pos_reg(imgs_.x - 10, imgs_.y + 7, cla)
                                                            hoilodo_point = True
                                                            time.sleep(0.5)
                                                        else:
                                                            full_path = "c:\\my_games\\ares\\data_ares\\imgs\\powerup\\hoilodo_point_10.PNG"
                                                            img_array = np.fromfile(full_path, np.uint8)
                                                            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                                            imgs_ = imgs_set_(150, 310, 800, 880, cla, img, 0.8)
                                                            if imgs_ is not None and imgs_ != False:
                                                                print("hoilodo_point_10", imgs_)
                                                                click_pos_reg(imgs_.x - 10, imgs_.y + 7, cla)
                                                                hoilodo_point = True
                                                                time.sleep(0.5)
                                                            else:
                                                                full_path = "c:\\my_games\\ares\\data_ares\\imgs\\powerup\\hoilodo_point_11.PNG"
                                                                img_array = np.fromfile(full_path, np.uint8)
                                                                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                                                imgs_ = imgs_set_(150, 310, 800, 880, cla, img, 0.8)
                                                                if imgs_ is not None and imgs_ != False:
                                                                    ...
                                                                    imgs_ = imgs_set_(150, 310, 800, 880, cla, img, 0.8)
                                                                    if imgs_ is not None and imgs_ != False:
                                                                        print("hoilodo_point_12", imgs_)
                                                                        click_pos_reg(imgs_.x - 10, imgs_.y + 7, cla)
                                                                        hoilodo_point = True
                                                                        time.sleep(0.5)
                                                                    else:
                                                                        full_path = "c:\\my_games\\ares\\data_ares\\imgs\\powerup\\hoilodo_point_13.PNG"
                                                                        img_array = np.fromfile(full_path, np.uint8)
                                                                        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                                                                        imgs_ = imgs_set_(150, 310, 800, 880, cla, img,
                                                                                          0.8)
                                                                        if imgs_ is not None and imgs_ != False:
                                                                            print("hoilodo_point_13", imgs_)
                                                                            click_pos_reg(imgs_.x - 10, imgs_.y + 7,
                                                                                          cla)
                                                                            hoilodo_point = True
                                                                            time.sleep(0.5)
                                                                        else:
                                                                            full_path = "c:\\my_games\\ares\\data_ares\\imgs\\powerup\\hoilodo_point_14.PNG"
                                                                            img_array = np.fromfile(full_path, np.uint8)
                                                                            img = cv2.imdecode(img_array,
                                                                                               cv2.IMREAD_COLOR)
                                                                            imgs_ = imgs_set_(150, 310, 800, 880, cla,
                                                                                              img,
                                                                                              0.8)
                                                                            if imgs_ is not None and imgs_ != False:
                                                                                print("hoilodo_point_14", imgs_)
                                                                                click_pos_reg(imgs_.x - 10, imgs_.y + 7,
                                                                                              cla)
                                                                                hoilodo_point = True
                                                                                time.sleep(0.5)
