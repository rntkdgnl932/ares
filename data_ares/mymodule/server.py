    ...
    try:
        ...
        if start_get == "yes":
            ...
            if result_my_server_read == 'start':
                ...
                file_path = "C:\\my_games\\ares\\data_ares\\mymodule\\version.txt"
                with open(file_path, "r", encoding='utf-8-sig') as file:
...
def server_get_ares():
    try:
        url = "https://raw.githubusercontent.com/rntkdgnl932/server/master/ares.txt"
...
def server_get_version():
    try:
        url = "https://raw.githubusercontent.com/rntkdgnl932/ares/master/data_ares/mymodule/version.txt"
